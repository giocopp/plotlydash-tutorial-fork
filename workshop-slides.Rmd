...
.details[.code120[
```{r, eval=T, message=FALSE, warning=FALSE, echo=F, fig.width=1.85, fig.height=1.15}
fig3a
```
]]
</details>
...
.details[.code120[
```{r, eval=TRUE, message=FALSE, warning=FALSE, echo=TRUE, fig.width=0.2, fig.height=0.2}
